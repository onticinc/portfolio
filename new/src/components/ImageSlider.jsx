...
export default function ImageSlider() {
  ...
  let image = [
    ...
    return (
      <Container>
      <div className="relative min-h-screen border border-zinc-100 justify-center  dark:border-zinc-700/40 ">
        <div class="flex items-center overscroll-contain overflow-x-scroll max-w-screen-2xl">
            {image.map((role, roleIndex) => (
              <div key={roleIndex} className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40 mt-10 gap-2 mr-4 bg-zinc-800">
