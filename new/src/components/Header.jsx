...
function DesktopNavigation(props) {
  return (
    <nav {...props}>
      <ul className="flex p-3 rounded-md bg-white/90 px-3 text-sm font-medium text-zinc-800 ml-16 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
...
function ModeToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-md bg-white/90 px-3 py-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur mr-16 transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
      onClick={toggleMode}
    >
