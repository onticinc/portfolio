...
function DesktopNavigation(props) {
  return (
    <nav {...props}>
      <ul className="flex bg-neutral-50 rounded-md bg-white/90 p-3 text-sm font-medium text-zinc-800 shadow-sm shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 lg:ml-8">
  ...
  return (
    <div className="mr-6">
      <button
        ...
        className="group rounded-md bg-neutral-50 px-3 py-2  ring-1 ring-orange-900/10 backdrop-blur transition  dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20 lg:-mr-4"
        onClick={toggleMode}
      >
