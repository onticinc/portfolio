...
function DesktopNavigation(props) {
  return (
    <nav {...props}>
      <ul className="flex bg-neutral-50 rounded-xl bg-white/90 p-3 text-sm font-medium text-zinc-800 shadow-sm shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 lg:ml-8">
