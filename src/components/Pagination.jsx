  ...
  return (
    <nav className="flex items-center justify-between px-4 sm:px-0">
      ...
      <div className="hidden md:-mt-px md:flex">
        <a
          href="#"
          className="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-indigo-500 hover:border-orange-500 hover:text-orange-500"
        >
          1
        </a>
